...
A separate, later, explicitly-authorized gate implemented the narrow backend correction the canonical Product graduation (`gera-os` `93be2a70405e9606eac69cd10c753057dd2f80d4`, "Duel Container vs. Mechanic") required: Multiple Choice was, until this gate, implicit in every generic-looking Duel type, command, and read-model field — this section documents making that explicit. This section documents that gate; §1–§21 above describe Duel v1 exactly as it was designed and deployed, unmodified.
